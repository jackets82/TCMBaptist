    ...
    <div className="bg-orange-600">
      <div className="max-w-5xl mx-auto">
        <p className=" text-center py-10">
          As well as our regular Sunday services, we also have youth work, men's
          and women's ministries and much more
        </p>
        <div className="grid grid-cols-3 place-items-center gap-10">
          <ExtraStuffTile title="Extra Time" />
          <ExtraStuffTile title="House Groups" />
          <ExtraStuffTile title="Mens Ministries" />
          <ExtraStuffTile title="Womens Ministries" />
