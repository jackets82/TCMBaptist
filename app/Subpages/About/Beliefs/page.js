    ...
    <div className=" flex-grow">
      ...
      <div>
        ...
        <div className=" max-w-6xl mx-auto px-10 xl:px-0 flex flex-col gap-5 pb-10 mt-20">
          ...
          <h1 className="text-3xl textgreen-600">1. God</h1>
          <p className="text-lg">
            There is one God, who exists eternally in three distinct but equal
            persons: the Father, the Son, and the Holy Spirit. God is
            unchangeable in his holiness, justice, wisdom and love. He is the
            almighty Creator, Saviour and Judge who sustains and governs all
